"""
Навык "сделать гифку" — конвертирует видео в анимированный GIF через
ffmpeg. Обрезаем по длительности и уменьшаем разрешение, иначе гифка
получится огромной (GIF сжимается куда хуже видео).
"""
